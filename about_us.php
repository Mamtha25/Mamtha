...
<body style="background-color:#FF3368;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <img src="statics/Mamtha.jpg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:black;">This website is created by</p>
            <h1 style="color:black; text-shadow:2px 2px 2px gray;">Mamtha S</h1>
            <p style="color:black;"><b>Intern at Sparks Foundation <br> Jyoti Nivas College Autonomous, Bangalore</b></p>
    </center>
